  ...
  initMap: function(mapCanvas) {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
      ...
      try {
        ...
        alert('Depois de conseguir a localização:\n' + err);
      }
    });
  },
  ...
  geocodeAddress: function(endereco) {
    localizacao.geocoder.geocode({
      ...
      if (status === google.maps.GeocoderStatus.OK) {
        ...
        myScript.notificacao("Não foi possível pesquisar o endereço",
          "Motivo: " + status, false);
      }
    });
  },
          ...
          */
          ...
          if (existeCep) {
            ...
            if (enderecoPais == "Brasil") {
              myScript.notificacao("Você está em:", results[0].formatted_address,
                true);
              ...
              myScript.notificacao(
                "Selecione uma localização válida (com CEP) e pertencente ao Brasil",
